    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-9">
                ...
                INNER JOIN platform ON platform.platform_id = gamer_table.platforms INNER JOIN game_image ON game_image.game_id = gamer_table.id WHERE gamer_table.tags LIKE '%puzzle%' LIMIT 15;";
