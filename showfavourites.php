    ...
    <div class="container" id="searchcontainer">
        <div class="row justify-content-md-center">
            ...
            <div class="col-12-md-auto">
                ...
                INNER JOIN platform ON platform.platform_id = gamer_table.platforms INNER JOIN game_image ON game_image.game_id = gamer_table.id WHERE favourite = '1';";
                        ...
                        echo "<p>You have " . $queryResult . " favourites listed</p>";
                        ?>
