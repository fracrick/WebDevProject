...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Daily offer</li>
        </ol>
    </nav>
    ...
    $sql = "SELECT *, gamer_genre.genre_ID, genre.genre_name, platform.platform, game_image.game_image_url FROM gamer_table INNER JOIN gamer_genre ON gamer_table.id = gamer_genre.game_ID INNER JOIN genre ON gamer_genre.genre_ID = genre.genre_id
                INNER JOIN platform ON platform.platform_id = gamer_table.platforms INNER JOIN game_image ON game_image.game_id = gamer_table.id WHERE gamer_table.id ='$rand';";
