...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <?php
            if (isset($_SESSION['username'])) {
                echo "<button type='Submit' name='submit-login' class=' btn btn-success d-line-block'>Log out</button>";
            } else {
                echo "
    ...
    <div class="container" id="searchcontainer">
        <div class="row justify-content-md-center">
            ...
            <div class="col-12-md-auto">
                ...
                INNER JOIN platform ON platform.platform_id = gamer_table.platforms INNER JOIN game_image ON game_image.game_id = gamer_table.id WHERE name LIKE '%$search%' OR release_date 
                            LIKE '%$search%' OR developer LIKE '%$search%' OR platform LIKE '%$search%' OR tags LIKE '%$search%' OR price LIKE '%$search%' OR genre_name LIKE '%$search%';";
