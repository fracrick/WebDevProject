...
if (($_SERVER['PHP_AUTH_USER'] == "francis") && ($_SERVER['PHP_AUTH_PW'] == "pass123")
) {
    ...
    <div class="container" id="logins">
        ...
        <div class="row">
            <div class="col-sm-8">
                ...
                <h2>Add games to Alien library</h2>
                <p>
                <form action="add.php" method="POST">
                    ...
                    <button type="Submit" name="submit-add" class=" btn btn-success d-line-block">Add game</button>
